...
147 migrations from `0001` through `0148`; `0021` is the sole intentional gap.
...
requires the complete checked-in `0001`-`0148` manifest, not merely the
...
the successful sqlx ledger with all 147 checked-in migrations from `0001`
through `0148` (including the intentional numbering gap at `0021`);
...
The `0001`-`0148` migration SQL and checksums used by both the one-shot migrator
