...
150 migrations from `0001` through `0151`; `0021` is the sole intentional gap.
...
requires the complete checked-in `0001`-`0151` manifest, not merely the
...
the successful sqlx ledger with all 150 checked-in migrations from `0001`
through `0151` (including the intentional numbering gap at `0021`);
...
The `0001`-`0151` migration SQL and checksums used by both the one-shot migrator
