...
| ARCH-SVC | Implemented | [PubSub application service](../src/services/pubsub.rs), [MIX application service](../src/services/mix.rs), [application state](../src/state.rs) | [architecture and MIX producer-admission boundary](../scripts/check-architecture-boundaries.mjs) | [architecture](ARCHITECTURE.md), [production operations](PRODUCTION_OPERATIONS.md) |
