...
const BASELINE = new Map([
  ...
  ['src/xmpp/protocol/muc/message.rs', 0],
  ['src/xmpp/protocol/muc/presence.rs', 0],
  ['src/xmpp/protocol/mix.rs', 0],
  ['src/xmpp/protocol/mix/forms.rs', 0],
  ['src/xmpp/protocol/mix/worker.rs', 0],
