...
149 migrations from `0001` through `0150`; `0021` is the sole intentional gap.
...
requires the complete checked-in `0001`-`0150` manifest, not merely the
...
the successful sqlx ledger with all 149 checked-in migrations from `0001`
through `0150` (including the intentional numbering gap at `0021`);
...
The `0001`-`0150` migration SQL and checksums used by both the one-shot migrator
