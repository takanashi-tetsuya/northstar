...
pub struct Metrics {
    ...
    pub http_insecure_requests_rejected_total: Arc<AtomicU64>,
    ...
    pub omemo_recovery_poll_requests_total: Arc<AtomicU64>,
    pub omemo_recovery_poll_rate_limited_total: Arc<AtomicU64>,
    pub omemo_recovery_poll_concurrency_rejected_total: Arc<AtomicU64>,
    pub omemo_recovery_poll_not_found_total: Arc<AtomicU64>,
    ...
    pub retention_muc_mam_deleted_total: Arc<AtomicU64>,
    pub retention_offline_messages_deleted_total: Arc<AtomicU64>,
    pub retention_personal_delivery_admissions_deleted_total: Arc<AtomicU64>,
    pub retention_moderation_cases_deleted_total: Arc<AtomicU64>,
    pub retention_legal_hold_snapshots_deleted_total: Arc<AtomicU64>,
    pub retention_audit_log_deleted_total: Arc<AtomicU64>,
    pub retention_governance_export_leases_deleted_total: Arc<AtomicU64>,
    pub retention_omemo_recovery_transfers_deleted_total: Arc<AtomicU64>,
    ...
    pub retention_cleanup_failures_total: Arc<AtomicU64>,
