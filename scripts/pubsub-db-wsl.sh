...
run_exact_ignored \
  db::pubsub::integration_tests::leaf_disco_uses_read_only_snapshot_and_live_subscription_scope
run_exact_ignored \
  db::pubsub::integration_tests::leaf_disco_sql_gate_matches_pure_retrieval_policy
run_exact_ignored \
