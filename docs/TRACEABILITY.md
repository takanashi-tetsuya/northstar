...
| DB-MANIFEST | Implemented | [migration 0126](../migrations/0126_mix_delivery_release_journal.sql), [migration 0127](../migrations/0127_sm_resume_authority_notifications.sql), [migration 0128](../migrations/0128_mix_capacity_authorities.sql), [migration 0129](../migrations/0129_pubsub_collection_edge_update_semantics.sql), [migration 0130](../migrations/0130_personal_message_admission_scope_lookup.sql), [migration 0131](../migrations/0131_upload_capacity_nowait.sql), [migration 0132](../migrations/0132_pubsub_collection_edge_path.sql), [migration 0133](../migrations/0133_mix_delivery_wake_notifications.sql), [migration 0134](../migrations/0134_mix_delivery_route_wake_generation.sql), [migration 0135](../migrations/0135_mix_transport_handoffs.sql), [migration 0136](../migrations/0136_sm_mix_teardown_release.sql), [migration 0137](../migrations/0137_mix_cluster_transport_handoffs.sql), [migration 0138](../migrations/0138_sm_mix_teardown_catalog.sql), [migration 0139](../migrations/0139_upload_cleanup_conflict_target.sql), [migration 0140](../migrations/0140_upload_projection_release_order.sql), [migration 0141](../migrations/0141_upload_cleanup_capability_rehardening.sql), [migration 0142](../migrations/0142_upload_projection_capacity_rehardening.sql), [migration 0143](../migrations/0143_upload_snapshot_plan_cache.sql), [migration 0144](../migrations/0144_account_revocation_outbox.sql), [migration 0145](../migrations/0145_webauthn_passkeys.sql), [migration 0146](../migrations/0146_upload_durable_state_probe.sql), [migration 0147](../migrations/0147_upload_storage_role_catalog_health.sql), [migration 0148](../migrations/0148_cluster_muc_admin_batch_kind.sql), [migration 0149](../migrations/0149_upload_storage_migration_journal.sql), [migration 0150](../migrations/0150_auth_generation_lock_capability.sql), [migration 0151](../migrations/0151_enabled_user_name_lock_capability.sql), [migration 0152](../migrations/0152_mix_mam_authoritative_page_index.sql), [embedded migrator](../src/db/mod.rs) | [migration version gate](../scripts/check-migration-versions.sh), [capability-manifest gate](../scripts/check-database-capability-manifest.py), [documentation gate](../scripts/check-documentation-consistency.mjs) | [database roles](DATABASE_ROLES.md), [release checklist](RELEASE_CHECKLIST.md) |
| CAPS-OBS | Implemented | [capability observation authority](../src/xmpp/protocol/caps.rs), [application state](../src/state.rs), [federated lifecycle](../src/s2s/inbound.rs) | [architecture gate](../scripts/check-architecture-boundaries.mjs), [protocol integration harness](../scripts/integration-wsl.sh) | [architecture](ARCHITECTURE.md), [production operations](PRODUCTION_OPERATIONS.md) |
...
| DUR-SM-AUTH | Implemented | [SM application service](../src/services/sm.rs), [SM repository adapter](../src/db/sm_repository.rs), [authority listener](../src/db/authority_listener.rs), [SM persistence](../src/db/sm.rs), [migration 0127](../migrations/0127_sm_resume_authority_notifications.sql) | [SM database harness](../scripts/sm-db-wsl.sh), [architecture gate](../scripts/check-architecture-boundaries.mjs) | [architecture](ARCHITECTURE.md), [production operations](PRODUCTION_OPERATIONS.md) |
...
| MIX-CAPACITY | Implemented | [MIX application service](../src/services/mix.rs), [MIX repository](../src/db/mix.rs), [release journal](../migrations/0126_mix_delivery_release_journal.sql), [exact authorities](../migrations/0128_mix_capacity_authorities.sql) | [MIX database harness](../scripts/mix-family-db-wsl.sh), [architecture gate](../scripts/check-architecture-boundaries.mjs) | [architecture](ARCHITECTURE.md), [production operations](PRODUCTION_OPERATIONS.md), [release checklist](RELEASE_CHECKLIST.md) |
...
| SEC-BACKUP | Implemented | [backup verifier](../scripts/backup-security.py), [restore state machine](../scripts/restore-backup.sh), [private dump validator](../scripts/validate-backup-dump-local.sh) | Runtime revalidation pending for the current commit: [offline fault harness](../scripts/backup-security-offline.sh), [isolated disaster-recovery harness](../scripts/backup-restore-wsl.sh), [static database-role boundary](../scripts/check-database-role-boundaries.sh) | [backup security](BACKUP_SECURITY.md), [production operations](PRODUCTION_OPERATIONS.md), [known issues](KNOWN_ISSUES.md) |
| ARCH-SVC | Confirmed | [PubSub application service](../src/services/pubsub.rs), [MIX application service](../src/services/mix.rs), [application state](../src/state.rs) | [architecture and MIX producer-admission boundary](../scripts/check-architecture-boundaries.mjs) | [architecture](ARCHITECTURE.md), [production operations](PRODUCTION_OPERATIONS.md) |
...
| CLU-MUC | Implemented | [MUC application service](../src/services/muc.rs), [MUC authority/outbox](../src/db/cluster_muc.rs), [migration 0089](../migrations/0089_cluster_muc_authority.sql), [admin batch migration 0148](../migrations/0148_cluster_muc_admin_batch_kind.sql) | [PostgreSQL room fixtures](../scripts/muc-db-wsl.sh), [standalone protocol suite](../scripts/test-muc-phase7.py), and [two-node cluster suite](../scripts/cluster-wsl.py) cover ordered admin batches, whole-batch rollback, exact occupancy renewal, replay conflicts and cross-node delivery | [clustering](CLUSTERING.md), [known issues](KNOWN_ISSUES.md) |
| CLU-STORAGE | Implemented | [upload store](../src/storage.rs), [direct-final S3 backend](../src/storage/s3.rs), [durable cleanup/scrub worker](../src/upload_worker.rs), [migration 0091](../migrations/0091_shared_upload_storage.sql) | Runtime qualification pending: pure fake-store crash/late-appearance/node-A→node-B/client-swap tests plus an ignored [loopback MinIO fixture](../scripts/lib/isolated-minio-fixture.sh); target-provider two-node, kill-point, rotation, lifecycle and restore runs remain release gates | [upload storage contract](UPLOAD_STORAGE.md), [clustering](CLUSTERING.md) |
| ARCH-MIGRATE-STORAGE | Implemented; runtime qualification pending | [offline migration command](../src/storage/migrate.rs), [migration journal](../src/db/upload_migration.rs), [migration 0149](../migrations/0149_upload_storage_migration_journal.sql) | [PostgreSQL journal fixture](../src/db/upload_migration.rs), [local/S3 migration harness](../scripts/test-storage-migration-wsl.sh) | [upload storage contract](UPLOAD_STORAGE.md), [production operations](PRODUCTION_OPERATIONS.md) |
| ARCH-RESTORE-OUTCOME | Implemented; runtime qualification pending | [restore outcome marker](../deploy/postgres-init/lib/ensure-northstar-restore-outcome-marker.sql), [restore recovery](../scripts/restore-recovery.py), [migration 0149](../migrations/0149_upload_storage_migration_journal.sql) | [recovery tests](../scripts/test-restore-recovery.py), [disaster-recovery harness](../scripts/backup-restore-wsl.sh) | [backup security](BACKUP_SECURITY.md), [production operations](PRODUCTION_OPERATIONS.md) |
...
| FED-REVOCATION | Implemented | [CRL classification and certificate-session registry](../src/crl.rs), [OCSP response validation](../src/ocsp.rs), [atomic generation/reload](../src/tls.rs), [C2S lifecycle](../src/xmpp/protocol.rs), [S2S lifecycle](../src/s2s) | pure exact-cancellation/classification/pin-policy tests, [generated CRL fixture](../scripts/generate-crl-fixture-wsl.sh) and [OCSP TLS fixture](../scripts/test-ocsp-stapling.sh); external CA rotation and peer interoperability remain release gates | [production operations](PRODUCTION_OPERATIONS.md) |
