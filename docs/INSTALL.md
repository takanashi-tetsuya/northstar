...
Use the complete archive for your platform: `northstar-0.2.1-linux-amd64.tar.gz`
or `northstar-0.2.1-windows-amd64.zip`. Both include the Web client, Swagger UI,
...
The output must be `xmpp-server 0.2.1`. Linux packages target x86-64 GNU/Linux
...
of the [production operations guide](https://github.com/takanashi-tetsuya/northstar/blob/v0.2.1/docs/PRODUCTION_OPERATIONS.md).
...
with [the release Compose override](https://github.com/takanashi-tetsuya/northstar/blob/v0.2.1/deploy/docker-compose.release.yml)
